...
public class GeneracionCodigoPersistenciaMysqlPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "GeneracionCodigoPersistenciaMysql";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new GeneracionCodigoPersistenciaMysqlPersistentManager();
		}
